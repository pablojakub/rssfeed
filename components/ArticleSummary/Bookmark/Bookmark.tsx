...
const Bookmark = (props: BookmarkProps) => {
    ...
    return (
        <StyledIconWrapper
            ...
            data-tooltip-content={isChecked
                ? 'Remove from favourites'
                : 'Add to favourites'}
        >
            {isChecked || isHovered ? <FilledStar /> : <OutlineStar />}
        </StyledIconWrapper>
    );
};
